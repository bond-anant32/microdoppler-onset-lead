...
so force-integrated and shape-based generators are consumed identically downstream.

Frame: ECEF (WGS84 via trajectory_math). SI units throughout.
Physics: maneuvers come from bounded lift/thrust added to gravity and drag, so a = v^2/r
holds by construction. Commanded specific force is clamped and eased (raised-cosine), so
