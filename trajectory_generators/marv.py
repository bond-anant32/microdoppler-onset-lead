...
KN-23 class). Ballistic midcourse, then a terminal pull-up and lateral S-weave once the
vehicle descends through pullup_trigger_alt_m. The terminal maneuver is lift added to
gravity and drag, clamped at a_max_g, under a half-sine envelope sin(pi*m) over
maneuver_dur_s, so it starts and ends at zero acceleration with no impulse.
