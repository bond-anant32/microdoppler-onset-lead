...
Gravity and aerodynamic drag only (no lift or thrust after launch). Apogee and range follow
from the launch speed and elevation angle. `depressed=True` caps the elevation at 22 deg for a
flatter, faster, lower-apogee trajectory, as Iskander/KN-23-class missiles fly to reduce radar
exposure.
